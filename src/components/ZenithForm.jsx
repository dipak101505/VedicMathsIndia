...
const ZenithForm = ({ studentData, onClose }) => {
      ...
      if (studentData?.id) {
        ...
        if (studentDoc.exists() && studentData?.save !== false) {
          ...
          const newPayment = {
            ...
            paymentMode:
              Object.keys(formData.paymentMode).find(
                (key) => formData.paymentMode[key],
              ) || "unknown",
          };
    ...
    <div style={styles.container}>
      <div style={styles.form}>
        <div style={styles.header}>
          ...
          <div style={styles.officeCopy}>
            {isOfficeCopy ? "Office Copy" : "Student Copy"}
          </div>
        </div>
        ...
        <div style={styles.particulars}>
          <span style={{ marginBottom: "0.2rem", fontWeight: "500" }}>
            Particulars:
          </span>
  ...
  return (
    <div>
      <div>
        {renderForm(true)}
        <div style={{ marginTop: "1rem" }}>{renderForm(false)}</div>
      </div>
